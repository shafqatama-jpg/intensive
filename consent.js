(function(){
  ...
  function injectBanner(){
    ...
    d.innerHTML =
      '<p class="text-xs sm:text-sm text-white/85 flex-1">We use cookies for essential site function and, with your consent, for analytics. See our <a href="cookie-policy.html" class="underline">Cookie Policy</a>.</p>' +
